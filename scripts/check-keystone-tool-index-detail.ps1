...
$repo = "keystone-tool-index-stack"
$language = "Python"
$category = "CLI tools"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/keystone-tool-index-walkthrough.md")) {
