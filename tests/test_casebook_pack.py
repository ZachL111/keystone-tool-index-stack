"""Regression checks for the keystone-tool-index-stack casebook."""
...
from casebook.harness import assert_expected, keystone_tool_index_stack_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(keystone_tool_index_stack_summary(), assert_expected())
